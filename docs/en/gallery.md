...
page_intro: "Three real slider views: overview, phone and DSLR."
---

{% assign links = site.data.public-links %}
{% assign routes = links.internal_routes_en %}

<p>The public gallery shows the most useful real hardware views inside the Smart Timelapse AI workflow: one overview, one phone setup and one DSLR setup.</p>
